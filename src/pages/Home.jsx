          ...
          <div className="max-w-6xl mx-auto">
            ...
            <div className="grid md:grid-cols-2 gap-12 items-center mb-20">
              <div>
                ...
                <p className="text-gray-600 mb-4 leading-relaxed">
                  ...
                  wholesale store known for providing high-quality provision
                  items at affordable prices. We supply a wide variety of daily
                  household groceries and essential products.
                </p>

                <p className="text-gray-600 mb-4 leading-relaxed">
                  Our store proudly operates the
                  <strong> Rajesh Masala Agency</strong>, providing authentic
                  and premium quality masala products. Customers can find all
            ...
            <div className="text-center mb-12">
              ...
              <p className="text-gray-600">
                ...
                founders dedicated to delivering the best grocery experience to
                customers.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-2 gap-10">
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition">
                ...
                <p className="text-gray-600">
                  Rajnish Singh plays a key role in managing the store
                  operations and ensuring customers receive quality grocery
                  products along with excellent service.
                </p>
              </div>
              ...
              <div className="bg-white p-8 rounded-2xl shadow-lg text-center hover:shadow-xl transition">
                ...
                <p className="text-gray-600">
                  Vikash Singh focuses on expanding the business and
                  strengthening the Rajesh Masala Agency while maintaining
